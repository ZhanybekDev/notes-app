...
const MESSAGES = {
  en: {
    ...
    settings: {
      ...
      telegramStatusUnavailable: 'Bot unavailable',
      telegramStatusDisconnected: 'Not connected',
      telegramStatusConnected: 'Connected',
      telegramUnavailableHint: 'Telegram reminders are unavailable until TELEGRAM_BOT_TOKEN is configured.',
      telegramDisconnectedHint: 'Generate a one-time code, then send it to the bot in Telegram.',
      telegramInstruction: 'Send this command to the bot:',
      telegramCodeExpires: 'Code expires: {expiresAt}',
      telegramGenerateCode: 'Generate code',
      telegramRefreshCode: 'Refresh code',
      telegramCodeGenerated: 'New Telegram link code generated.',
      telegramConnectedAs: 'Connected as {username}.',
      telegramConnectedFallback: 'Telegram is connected.',
      telegramEnableNotifications: 'Enable date reminders',
      telegramSettingsSaved: 'Telegram reminder settings saved.',
  ...
  ru: {
    ...
    settings: {
      ...
      telegramLoading: 'Загрузка настроек Telegram...',
      telegramStatusUnavailable: 'Бот недоступен',
      telegramStatusDisconnected: 'Не подключено',
      telegramStatusConnected: 'Подключено',
      telegramUnavailableHint: 'Напоминания в Telegram недоступны, пока не настроен TELEGRAM_BOT_TOKEN.',
      telegramDisconnectedHint: 'Сгенерируйте одноразовый код и отправьте его боту в Telegram.',
      telegramInstruction: 'Отправьте боту эту команду:',
      telegramCodeExpires: 'Код истекает: {expiresAt}',
      telegramGenerateCode: 'Сгенерировать код',
      telegramRefreshCode: 'Обновить код',
      telegramCodeGenerated: 'Новый код привязки Telegram создан.',
      telegramConnectedAs: 'Подключено как {username}.',
      telegramConnectedFallback: 'Telegram подключён.',
      telegramEnableNotifications: 'Включить напоминания по дате',
      telegramSettingsSaved: 'Настройки Telegram сохранены.',

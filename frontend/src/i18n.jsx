...
const MESSAGES = {
  en: {
    ...
    settings: {
      ...
      telegramHint: "Get a Telegram message when a note's date arrives.",
      telegramNotConfigured: 'The Telegram bot is not configured on the server.',
      telegramLink: 'Link Telegram',
      telegramLinkHint: 'Open this link and press Start in Telegram to connect your account.',
      telegramLinked: 'Telegram linked',
      telegramNotLinked: 'Not linked yet',
      telegramRefresh: 'Refresh status',
      telegramUnlink: 'Unlink',
      telegramReminders: 'Send reminders',
      timezoneTitle: 'Timezone',
      timezoneHint: "Reminders fire at the start of the note's day in this timezone.",
      timezoneSaved: 'Timezone saved.',
      exportTitle: 'Export',
      exportHint: 'Download all your notes as a zip of Markdown files.',
    ...
    share: {
      readOnly: 'Shared note (read-only)',
      notFound: 'This note is not shared, or the link is invalid.',
      loading: 'Loading...',
    },
  },
  ru: {
    ...
    settings: {
      ...
      telegramHint: 'Получайте сообщение в Telegram, когда наступает дата заметки.',
      telegramNotConfigured: 'Бот Telegram не настроен на сервере.',
      telegramLink: 'Привязать Telegram',
      telegramLinkHint: 'Откройте ссылку и нажмите Start в Telegram, чтобы привязать аккаунт.',
      telegramLinked: 'Telegram привязан',
      telegramNotLinked: 'Ещё не привязан',
      telegramRefresh: 'Обновить статус',
      telegramUnlink: 'Отвязать',
      telegramReminders: 'Отправлять напоминания',
      timezoneTitle: 'Часовой пояс',
      timezoneHint: 'Напоминания срабатывают в начале дня заметки в этом часовом поясе.',
      timezoneSaved: 'Часовой пояс сохранён.',
      exportTitle: 'Экспорт',
      exportHint: 'Скачайте все заметки в виде zip-архива Markdown-файлов.',
      exportAll: 'Экспортировать всё (.zip)',
    },
    shortcuts: {
    ...
    share: {
      readOnly: 'Публичная заметка (только чтение)',
      notFound: 'Заметка не расшарена или ссылка недействительна.',
      loading: 'Загрузка...',
    },
  },
};

/*
 * The message catalogue and the pure lookup on top of it.
 *
 * Kept apart from `i18n.jsx` because stores translate too, and the store layer is headless by
 * contract — importing a module that also exports React hooks into it would break that claim even
 * though `translate` itself is pure. `i18n.jsx` re-exports both names, so call sites are free to
 * keep importing from wherever reads better.
 */
...
export const MESSAGES = {
  en: {
    ...
    share: {
      ...
      hint: 'Anyone with the link can read this note. Archiving it takes the link down.',
      readOnly: 'Shared note',
      notFound: 'This link does not work',
  ...
  ru: {
    ...
    share: {
      action: 'Поделиться',
      shared: 'Ссылка активна',
      copy: 'Скопировать ссылку',
      copied: 'Ссылка скопирована',
      revoke: 'Отозвать',
      revoked: 'Ссылка отозвана',
      hint: 'Заметку прочитает любой, у кого есть ссылка. Архивация ссылку отключает.',
      readOnly: 'Заметка по ссылке',
